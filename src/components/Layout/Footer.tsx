...
const Footer = () => {
  return (
    <footer className="w-full px-4 py-2 border-t border-t-neutral-800 flex flex-col md:flex-row items-center justify-between bg-background text-foreground text-sm">
